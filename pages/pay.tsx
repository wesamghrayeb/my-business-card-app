...
export default function Pay() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "radial-gradient(circle at 60% 10%, #00ccff22 0%, #121213 55%, #181920 100%)",
      display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem 0",
    }}>
      <div className="card-glow" style={{
        background: "#181b22", borderRadius: 20, boxShadow: "0 6px 40px #00ccff35, 0 1.5px 18px #000b",
        maxWidth: 500, width: "96vw", margin: "2rem auto", padding: "2.3rem 2.1rem 1.7rem 2.1rem",
        border: "1.5px solid #222", position: "relative",
      }}>
        {!form ? (
          <div style={{ textAlign: "center", color: "#00ccff", fontWeight: 700, fontSize: "1.32rem" }}>
            Loading...
          </div>
        ) : (
          <>
            <h1 className="title has-text-centered mb-5" style={{
              color: "#00ccff", letterSpacing: 2, fontWeight: 900, fontSize: "2.25rem",
              marginBottom: "1.9rem", textShadow: "0 2px 12px #00ccff88",
            }}>
            ...
            <div className="has-text-centered mt-5" style={{ textAlign: "center" }}>
              <button
                ...
                style={{
                  fontSize: "1.17rem", fontWeight: 800, marginTop: 14,
                  background: "linear-gradient(95deg,#25d366 0%,#6befff 100%)",
                  color: "#0e232a", border: "none", borderRadius: 11,
                  boxShadow: "0 2px 10px #00ccff55", padding: "0.88rem 2.4rem",
                  textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.65em",
              ...
              >
                <img src="/whatsapp.png" alt="WhatsApp"
                  style={{
                    width: 28, height: 28, borderRadius: "50%", marginRight: 7, background: "#fff",
                  }}
                />
                {loading ? "Sending..." : "Contact Us to Get Your Link"}
              </button>
              <p className="help mt-2" style={{
                color: "#00ccff", marginTop: "1.3em", fontWeight: 500,
              }}>
        ...
        {showModal && (
          ...
          >
            <div
              style={{
                background: "#fff", borderRadius: 13, padding: "2.2rem 2.5rem", maxWidth: 370, textAlign: "center",
                boxShadow: "0 2px 20px #0004", position: "relative"
              }}
            ...
            >
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(95deg,#25d366 0%,#6befff 100%)",
                  color: "#0e232a", fontWeight: 800, border: "none", borderRadius: 10,
                  padding: "0.73em 2em", marginTop: 6, cursor: "pointer"
                }}
              >
                Got it!
              </button>
